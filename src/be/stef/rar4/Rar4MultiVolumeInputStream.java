 ...
 * spread across multiple RAR4 volumes, presenting them as one continuous stream.
 *
 * @author Stef
 * @since 1.0
 */
public class Rar4MultiVolumeInputStream extends InputStream {
    ...
    public Rar4MultiVolumeInputStream(List<Segment> segments) throws IOException {
